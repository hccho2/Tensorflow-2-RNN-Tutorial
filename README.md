...
- TensorFlow SIG(Special Interest Group) <a href="https://www.tensorflow.org/addons/overview?hl=ko" target="_blank">Addons</a>은 Tensorflow에서 사용할 수 없는 기능을 추가로 구현한 API를 모아놓은 것이다. 
<a href="https://www.tensorflow.org/addons/overview?hl=ko" target="_blank" rel="noopener"><span>Addons Text</span> </a>
...
## 1. [Basic RNN Model](https://github.com/hccho2/RNN-Tutorial/tree/master/0.%20Basic)
